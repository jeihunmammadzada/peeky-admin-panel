import { GetRouteComplaintCountByQuestion } from "@/utils/actions";
...
const RouteIssueTrendsChart = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      await GetRouteComplaintCountByQuestion(dates.beginDate, dates.endDate)
        .then((res) => {
          if (res) {
            const dchart = {
              datasets: [
...
RouteIssueTrendsChart.layout = "Contentlayout"
export default RouteIssueTrendsChart;