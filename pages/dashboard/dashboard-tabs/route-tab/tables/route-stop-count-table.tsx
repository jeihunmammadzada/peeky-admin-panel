...
import { GetRoutePlaceAndCountRating } from "@/utils/actions";
...
const RouteStopCount = () => {
  ...
  const getList = async () => {
    setLoading(true);
    await GetRoutePlaceAndCountRating(dates.beginDate, dates.endDate)
      .then((res) => {
        setLoading(false);
        if (res) {
...
RouteStopCount.layout = "Contentlayout"
export default RouteStopCount;