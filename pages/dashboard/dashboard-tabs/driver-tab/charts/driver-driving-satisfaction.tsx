...
import { GetEmployeeDrivingConditionSatisfaction } from '@/utils/actions';
...
const DriverDrivingSatisfaction = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      await GetEmployeeDrivingConditionSatisfaction(dates.beginDate, dates.endDate)
        .then((res) => {
          if (res) {
            const chartData = {
              labels: ["Razı", "Narazı"],
...
DriverDrivingSatisfaction.layout = "Contentlayout"
export default DriverDrivingSatisfaction