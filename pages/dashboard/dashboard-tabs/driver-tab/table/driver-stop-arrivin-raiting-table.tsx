...
import { GetEmployeeDisciplineRating } from "@/utils/actions";
import { Card, Table } from "react-bootstrap";
import { RatingResult } from "@/utils/responseModels";
import Loading from "@/pages/dashboard/loading";

const DriverStopArrivingRaitingTable = () => {
  ...
  const getList = async () => {
    setLoading(true);
    await GetEmployeeDisciplineRating(dates.beginDate, dates.endDate)
      .then((res) => {
        setLoading(false);
        if (res) {
  ...
  return (
    <>
      ...
      <h6
        ...
        >
          Sürücülərin dayanacağa vaxtında çatma reytinqi
        </h6>
...
DriverStopArrivingRaitingTable.layout = "Contentlayout"
export default DriverStopArrivingRaitingTable;
