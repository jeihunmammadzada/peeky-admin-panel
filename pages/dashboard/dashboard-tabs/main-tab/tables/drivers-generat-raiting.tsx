...
const DriversGeneralRating = () => {
  ...
  useEffect(() => {
    const getList = async () => {
      try {
        setLoading(true);
        const res = await GetEmployeeRating(dates.beginDate, dates.endDate);
        setLoading(false);
              ...
              <Table style={{ marginTop: "20px" }} borderless className="text-nowrap">
                <thead>
                  <tr>
                    ...
                    <th style={{ textTransform: "initial" }} scope="col">Adı və soyadı</th>
              ...
              <Table borderless className="text-nowrap">
                <thead>
                  <tr>
                    ...
                    <th style={{ textTransform: "initial", backgroundColor: "#6D6AFF", color: "white" }} scope="col">Adı və soyadı</th>
...
DriversGeneralRating.layout = "Contentlayout";
export default DriversGeneralRating;