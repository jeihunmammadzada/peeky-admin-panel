...
const BusVentilationSatisfaction = () => {
    ...
    useEffect(() => {
      ...
      const fetchData = async () => {
        await GetVehicleVentilationSatisfaction(dates.beginDate, dates.endDate)
          .then((res) => {
            if (res) {
              const chartData = {
                labels: ["Razı", "Narazı"],
...
BusVentilationSatisfaction.layout = "Contentlayout";
export default BusVentilationSatisfaction