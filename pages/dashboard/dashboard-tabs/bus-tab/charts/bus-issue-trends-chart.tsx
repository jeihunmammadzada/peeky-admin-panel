import { GetVehicleComplaintCountByQuestion } from "@/utils/actions";
...
const BusIssueTrendsChart = () => {
  ...
  useEffect(() => {
      ...
      const fetchData = async () => {
        await GetVehicleComplaintCountByQuestion(dates.beginDate, dates.endDate)
          .then((res) => {
            if (res) {
              const dchart = {
                datasets: [
...
BusIssueTrendsChart.layout = "Contentlayout";

export default BusIssueTrendsChart;
