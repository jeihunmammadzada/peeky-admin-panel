...
import { GetVehicleVentilationRating } from "@/utils/actions";
import { Card, Table } from "react-bootstrap";
import { RatingResult } from "@/utils/responseModels";
import Loading from "@/pages/dashboard/loading";

const BusVentilationRaiting = () => {
  ...
  const getList = async () => {
    setLoading(true);
    await GetVehicleVentilationRating(dates.beginDate, dates.endDate)
      .then((res) => {
        setLoading(false);
        if (res) {
...
BusVentilationRaiting.layout = "Contentlayout";
export default BusVentilationRaiting;