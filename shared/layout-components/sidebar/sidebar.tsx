...
const SideBar = ({
  ...
  useEffect(() => {
    setUserRoles(localStorage.getItem("user_roles")?.split(","));
  }, []);
    ...
    <Fragment>
      ...
      >
        <div className="main-sidebar-header">
          ...
          >
            <img
              src={"../../../public/assets/images/custom/logo.png"}
            ...
            <img
              ...
              }/assets/images/custom/toggle-logo.png`}
          ...
          <nav className="main-menu-container nav nav-pills flex-column sub-open">
            ...
            >
              {menuitems.map((Item: any) => (
                <>
                    {Item?.role?.some((role: any) => userRoles?.includes(role)) &&
